        ...
        <div class="login-container">
            <div class="card login-card">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary btn-block mb-3" @click.prevent="handleGoogleSignIn" :disabled="isLoading">
                        {{ isLoading ? 'Signing in...' : 'Sign in with Google' }}
                    </button>

                    <div class="text-center my-3">
                        <small class="text-muted">Fast, secure sign-in with your Google account</small>
                    </div>
